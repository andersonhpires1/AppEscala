# Código Fonte do Cabeçalho (Header)

Aqui está o HTML e Angular completo correspondente ao `<header id="global_master_header">` para que você possa copiar e utilizar em um novo projeto.
